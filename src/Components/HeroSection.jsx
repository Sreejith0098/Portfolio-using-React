...
const HeroSection = () => {
  return (
    <>
      <div
        className="container-fluid px-3 px-md-4 px-lg-5"
        style={{ minHeight: "88vh", paddingTop: "140px" }}
      >
          ...
          >
            <div style={{ marginTop: "60px" }} className="mt-md-4 mt-lg-5">
              ...
              <p className="fs-6 fs-md-5">
                ...
                applications. I specialize in front-end development using HTML,
                CSS, JavaScript, and modern frameworks like React and Vue.js, as
                well as back-end technologies such as Node.js and Express.
              </p>
